    ...
    return (<div name="skills" className='bg-gradient-to-b from-gray-800 to-black'>
        <div className='place-items-center grid gap-5 md:grid-cols-2 text-white mx-5 md:mx-20 p-10 h-full'>
            ...
            <div className='h-full'>
                <p className='text-center text-3xl font-bold border-b-4 border-gray-500'>Credits</p>
                <div className='my-10 text-center text-xl text-gray-500 '>
            ...
            <div className='h-full'>
                <p className='text-center text-3xl font-bold border-b-4 border-gray-500 inline-'>Socials</p>
                <div className='my-10 grid grid-cols-4 gap-10 text-center text-xl text-gray-500 '>
